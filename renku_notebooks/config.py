...
CULLING_REGISTERED_IDLE_SESSIONS_THRESHOLD_SECONDS = int(os.getenv(
    "CULLING_REGISTERED_IDLE_SESSIONS_THRESHOLD_SECONDS", 86400
))
CULLING_ANONYMOUS_IDLE_SESSIONS_THRESHOLD_SECONDS = int(os.getenv(
    "CULLING_ANONYMOUS_IDLE_SESSIONS_THRESHOLD_SECONDS", 43200
))
