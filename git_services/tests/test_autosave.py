...
@pytest.fixture
def mock_rpc_server_cli():
    original_cli = rpc_server.GitCLI
    mocked_cli = mock.MagicMock(spec=original_cli)
...
@mock.patch.dict(os.environ, {"MOUNT_PATH": "."}, clear=True)
def test_autosave_clean(git_repo_with_user, mock_rpc_server_cli):
...
def test_autosave_unpushed_changes(git_repo_with_user, mock_rpc_server_cli):
    """Test no autosave branch is created on clean repo."""
...
@pytest.mark.parametrize(
    "status_file_line",
    [
        "1 .M N... 100644 100644 100644 a85b3a6c6138a9a88f4283091130eaa1bb8853c8 a85b3a6c6138a9a88f4283091130eaa1bb8853c8",
        "? ",
        "1 A. N... 000000 100644 100644 0000000000000000000000000000000000000000 abaf41b0f32d48161d59df7c95b40afe5d5227f8 ",
        "2 R. N... 100644 100644 100644 abaf41b0f32d48161d59df7c95b40afe5d5227f8 abaf41b0f32d48161d59df7c95b40afe5d5227f8 R100",
    ],
)
@mock.patch.dict(
    os.environ,
...
def test_autosave_dirty_changes(
    status_file_line, git_repo_with_user, mock_rpc_server_cli
):
    """Test no autosave branch is created on clean repo."""
